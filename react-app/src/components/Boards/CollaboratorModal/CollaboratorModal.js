      ...
      <div className="modal-content">
        <div id="collaborators-modal-container">
          <div id="invite-collaborator-title-container">
            <div id="invite-collaborator-title">Collaborators</div>
          </div>
          ...
          <div className="show-collaborator-content">
            ...
            <p>
              Save Pins, organize them, comment, and react. For more
              permissions, reach out to the board owner!
            </p>
          </div>
          ...
          <ol id="collaborators-list">
            <div
              ...
              onClick={() => history.push(`/${owner.username}`)}
            >
            ...
            {collaborators?.map((user) => (
              <li
                key={user.id}
                className="single-user-container-with-button"
          ...
          {isOwner && (
            <div
              id="edit-board-collaborator-modal-container-collaborator-modal"
              className="a99"
            >
              <EditBoardModalHelper
                className="open-collaborator-invite"
                itemText={
                  <div id="detail-collaborator-modal-invite-button-container">
                    <div className="edit-board-add-collaborator-button-container-red a97">
                ...
                modalComponent={
                  <InviteCollaborator board={board} isInDetailPage={true} />
                }
              />
            </div>
          )}
